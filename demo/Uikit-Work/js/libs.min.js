...
! function (t, e) {
  ...
  function Tt(t, s, e) {
    ...
    Ct(t = t.replace(_t, "$1 *")) && (a = [], t = t.match(At).map(function (t) {
      ...
      var n, i, r, o = s;
      return "!" === t[0] && (n = t.substr(1).trim().split(" "), o = Bt(Pt(s), n[0]), t = n.slice(1).join(" ").trim()), "-" === t[0] && (i = t.substr(1).trim().split(" "), r = (o || s).previousElementSibling, o = zt(r, t.substr(1)) ? r : null, t = i.slice(1).join(" ")), o ? (o.id || (o.id = "uk-" + Date.now() + e, a.push(function () {
        return at(o, "id")
      })), "#" + Ht(o.id) + " " + t) : null
  ...
  function Bt(t, e) {
    return w(e, ">") && (e = e.slice(1)), N(t) ? Dt.call(t, e) : V(t).map(function (t) {
      return Bt(t, e)
    }).filter(Boolean)
  }
  ...
  function Ut(t, e) {
    for (var n = []; t = Pt(t);) e && !zt(t, e) || n.push(t);
    return n
  }
  ...
  function Xt() {
    ...
    return 1 < u.length && (n = u, u = function (t) {
      ...
      }(o, a, u)), h = te(h), s.split(" ").forEach(function (e) {
  ...
  function Le(t) {
    ...
    r.length && (i = D(J(r = Fe(r))) ? [] : r.pop(), r = r.filter(Boolean), V(t).forEach(function (t) {
  ...
  function Xe(t) {
    ...
    return ct ? (t in Ye || (De(e = be(n, document.createElement("div")), "uk-" + t), Ye[t] = Ue(e, "content", ":before").replace(/^["'](.*)["']$/, "$1"), $e(e)), Ye[t]) : qe(n).getPropertyValue("--uk-" + t)
  }
  var Ge = {};
    ...
    return void 0 === s && (s = 200), ae.all(V(t).map(function (o) {
      return new ae(function (n, i) {
        ...
        Jt(o, "animationend animationcanceled", function (t) {
          ...
          self: !0
        }), Re(o, "animationDuration", s + "ms"), De(o, e, tn + (u ? "leave" : "enter")), w(e, tn) && De(o, a && "uk-transform-origin-" + a, u && tn + "reverse")
      })
    }))
  }
  ...
  function sn(t, e, c, l, d, n, i, r) {
    ...
    var o, p = un(t),
      g = un(e),
      m = g;
    return gn(m, c, p, -1), gn(m, l, g, 1), d = vn(d, p.width, p.height), n = vn(n, g.width, g.height), d.x += n.x, d.y += n.y, m.left += d.x, m.top += d.y, i && (o = [un(R(t))], r && o.unshift(un(r)), K(on, function (t, s) {
      var a = t[0],
        u = t[1],
        h = t[2];
      !0 !== i && !b(i, a) || o.some(function (i) {
        ...
        function o(e, t) {
          ...
          if (n >= i[u] && n + p[s] <= i[h]) return m[u] = n, ["element", "target"].forEach(function (t) {
  ...
  function an(n, i) {
    ...
    ["left", "top"].forEach(function (t) {
      var e;
      t in i && (e = Re(n, t), Re(n, t, i[t] - r[t] + F("absolute" === o && "auto" === e ? hn(n)[t] : e)))
    })
  }
  ...
  function un(t) {
    ...
    Ft(t) || "none" !== Re(t, "display") || (e = ot(t, "style"), n = ot(t, "hidden"), ot(t, {
  ...
  function bn(t, e, n) {
    return void 0 === e && (e = "width"), void 0 === n && (n = window), P(t) ? +t : h(t, "vh") ? xn(ln(R(n)), t) : h(t, "vw") ? xn(dn(R(n)), t) : h(t, "%") ? xn(un(n)[e], t) : F(t)
  }
  ...
  function Rn(u, h, c) {
    if (void 0 === h && (h = 0), void 0 === c && (c = 0), !Ft(u)) return !1;
    var l = Jn(u);
  ...
  function li(t, e) {
    ...
    for (var s in r) {
      var a = d(s),
        u = ut(o, a);
      H(u) || (u = r[s] === Boolean && "" === u || fi(r[s], u), ("target" !== a || u && !w(u, "_")) && (n[s] = u))
    }
    var h = Mn(ut(o, e), i);
    for (var c in h) {
      var l = f(c);
  ...
  ti.util = Object.freeze({
      ...
      scrollParents: Xn,
      getViewport: Gn
    }), ti.data = "__uikit__", ti.prefix = "uk-", ti.options = {}, ti.version = "3.5.7", ii = (ei = ti).data, ei.use = function (t) {
      ...
      var u, h = this,
        c = this._frames;
      c._watch || (u = !l(c, "_watch"), c._watch = yn.read(function () {
        if (h._connected) {
      ...
      var e;
      for (e in t = t || li(this.$options, this.$name)) H(t[e]) || (this.$props[e] = t[e]);
    ...
    }, ui = (ai = ti).data, hi = {}, ai.component = function (s, t) {
      var e = d(s);
      if (s = f(e), !t) return T(hi[s]) && (hi[s] = ai.extend(hi[s])), hi[s];
      ai[s] = function (t, n) {
    ...
    gi = {
      ...
      methods: {
        ...
        _toggleElement: function (t, e, n) {
          var i = this;
          if (e = z(e) ? e : rn.inProgress(t) ? He(t, "uk-animation-leave") : Qe.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t), !Kt(t, "before" + (e ? "show" : "hide"), [this])) return ae.reject();
        ...
        _toggle: function (t, e) {
          var n;
          t && (e = Boolean(e), this.cls ? (n = b(this.cls, " ") || e !== He(t, this.cls)) && Le(t, this.cls, b(this.cls, " ") ? void 0 : e) : (n = e === st(t, "hidden")) && ot(t, "hidden", e ? null : ""), Me("[autofocus]", t).some(function (t) {
    ...
    Ii = {
      ...
      methods: {
        ...
        position: function () {
          ...
          "justify" === this.align ? (t = "y" === this.getAxis() ? "width" : "height", Re(this.$el, t, n[t])) : this.$el.offsetWidth > Math.max(e.right - n.left, n.right - e.left) && De(this.$el, this.clsDrop + "-stack"), this.positionAt(this.$el, this.boundaryAlign ? this.boundary : this.toggle.$el, this.boundary)
        }
      }
    };
  var Si = {
    ...
    for (var i = [
      ...
      if (Ft(o))
        for (var s = Ai(o), a = i.length - 1; 0 <= a; a--) {
          ...
          var h = void 0,
            h = u[0].offsetParent === o.offsetParent ? Ai(u[0]) : (s = Ai(o, !0), Ai(u[0], !0));
  ...
  var Ni = {
    ...
    update: [{
      ...
      read: function (t) {
        ...
        var r, o, s, a, u, h = i.some(Qe.inProgress),
          c = !1,
          l = e.map(function (t) {
            return t.reduce(function (t, e) {
    ...
    update: {
      read: function (t) {
        ...
        if (this.expand) {
          ...
          var r, n = "calc(100vh";
          this.offsetTop && (n += 0 < (r = an(this.$el).top) && r < ln(window) / 2 ? " - " + r + "px" : ""), !0 === this.offsetBottom ? n += " - " + Oi(this.$el.nextElementSibling) + "px" : P(this.offsetBottom) ? n += " - " + this.offsetBottom + "vh" : this.offsetBottom && h(this.offsetBottom, "px") ? n += " - " + F(this.offsetBottom) + "px" : D(this.offsetBottom) && (n += " - " + Oi(yt(this.offsetBottom, this.$el)) + "px"), n += (i ? " - " + i + "px" : "") + ")"
        }
        return {
          minHeight: n,
          prev: e
  ...
  var Hi = {
      ...
      disconnected: function () {
        var e = this;
        jt(this.$el) && ot(this.$el, "hidden", null), this.svg && this.svg.then(function (t) {
      ...
      methods: {
        ...
        applyAttributes: function (n) {
          var i = this;
          for (var t in this.$options.props) this[t] && b(this.include, t) && ot(n, t, this[t]);
          ...
          h && !u.some(function (t) {
            return t
          }) && (u = h.split(" ").slice(2)), u.forEach(function (t, e) {
  ...
  var cr = {
    ...
    fr = {
      ...
      events: [{
        ...
        handler: function () {
          var o = this;
          dn(window) - dn(document) && this.overlay && Re(document.body, "overflowY", "scroll"), this.stack && Re(this.$el, "zIndex", F(Re(this.$el, "zIndex")) + dr.length), De(document.documentElement, this.clsPage), this.bgClose && Jt(this.$el, "hide", Xt(document, gt, function (t) {
            var r = t.target;
  ...
  var gr = {
    ...
    events: [{
      ...
      self: !0,
      handler: function () {
        He(this.panel, "uk-margin-auto-vertical") ? De(this.$el, "uk-flex") : Re(this.$el, "display", "block"), ln(this.$el)
      }
    }, {
      name: "hidden",
      self: !0,
  ...
  var mr = {
    ...
    vr = {
      ...
      events: [{
        ...
        handler: function (t, e) {
          var n = e.$el,
            i = e.dir;
          "slide" === this.dropbarMode && De(this.dropbar, "uk-navbar-dropbar-slide"), this.clsDrop && De(n, this.clsDrop + "-dropbar"), "bottom" === i && this.transitionTo(n.offsetHeight + F(Re(n, "marginTop")) + F(Re(n, "marginBottom")), n)
        }
      }, {
        name: "beforehide",
        filter: function () {
    ...
    wr = {
      ...
      events: [{
        ...
        self: !0,
        handler: function () {
          "reveal" !== this.mode || He(this.panel.parentNode, this.clsMode) || (Ie(this.panel, "<div>"), De(this.panel.parentNode, this.clsMode)), Re(document.documentElement, "overflowY", this.overlay ? "hidden" : ""), De(document.body, this.clsContainer, this.clsFlip), Re(document.body, "touch-action", "pan-y pinch-zoom"), Re(this.$el, "display", "block"), De(this.$el, this.clsOverlay), De(this.panel, this.clsSidebarAnimation, "reveal" !== this.mode ? this.clsMode : ""), ln(document.body), De(document.body, this.clsContainerAnimation), this.clsContainerAnimation && (br().content += ",user-scalable=0")
        }
      }, {
        name: "hide",
        self: !0,
      ...
      update: [{
        read: function () {
          ...
          return i === s ? a = t - 1 : (this.targets.every(function (t, e) {
            if (hn(t, o).top - n.offset <= 0) return a = e, !0
        ...
        write: function (t) {
          ...
          this.links.forEach(function (t) {
            return t.blur()
          }), Be(this.elements, this.cls), !1 !== e && Kt(this.$el, "active", [e, De(this.elements[e], this.cls)])
        },
        events: ["scroll", "resize"]
      }]
    },
    Tr = {
      ...
      update: [{
        ...
        write: function (t) {
          ...
          Re(i, G({
            height: e
          }, n)), qt(i, document) || (ye(this.$el, i), ot(i, "hidden", "")), this.isActive = !!this.isActive
        },
        events: ["resize"]
      }, {
        read: function (t) {
        ...
        write: function (t, e) {
          ...
          if (!((t.lastScroll = u) < 0 || u === a && "scroll" === e || this.showOnUp && "scroll" !== e && !this.isFixed || ((300 < i - r || o !== s) && (t.initScroll = u, t.initTimestamp = i), t.lastDir = o, this.showOnUp && !this.isFixed && Math.abs(t.initScroll - u) <= 30 && Math.abs(a - u) <= 10)))
            if (this.inactive || u < this.top || this.showOnUp && (u <= this.top || "down" === o && "scroll" === e || "up" === o && !this.isFixed && u <= this.bottomOffset)) {
              if (!this.isFixed) return void(rn.inProgress(this.$el) && u < h && (rn.cancel(this.$el), this.hide()));
      ...
      methods: {
        ...
        update: function () {
          ...
          P(this.bottom) && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll), Re(this.$el, {
            ...
            top: e + "px",
            width: this.width
          }), this.isActive = t, Le(this.$el, this.clsBelow, this.scroll > this.bottomOffset), De(this.$el, this.clsFixed)
        }
      }
    };
  ...
  function Er(t, e) {
    var n = e.$props,
      ...
      r = e[t + "Offset"],
      o = n[t];
    if (o) return D(o) && o.match(/^-?\d/) ? r + bn(o) : an(!0 === o ? i.parentNode : yt(o, i)).bottom
  }
  var _r, Cr, Ar, Nr = {
      mixins: [gi],
      args: "connect",
    ...
    zr = {
      ...
      events: [{
        ...
        handler: function (t) {
          var e;
          (Bt(t.target, 'a[href="#"], a[href=""]') || (e = Bt(t.target, "a[href]")) && (this.cls && !He(this.target, this.cls.split(" ")[0]) || !Ft(this.target) || e.hash && zt(this.target, e.hash))) && t.preventDefault(), this.toggle()
        }
      }],
      update: {
        read: function () {
  ...
  }), Cr = (_r = ti).connect, Ar = _r.disconnect, ht && window.MutationObserver && yn.read(function () {
    ...
    Or = {
      ...
      methods: {
        animate: function (t, i) {
          ...
          return De(i, Pr), r.forEach(function (t, e) {
            return o[e] && Re(t, o[e])
          }), Re(i, {
            height: e,
            display: "block"
  ...
  function Vr(t, e, n) {
    ...
    var s, a, u, h = t.sort,
      c = h[0],
      l = h[1];
    c && (a = c, u = l, Y(s = G([], n).sort(function (t, e) {
      ...
      methods: {
        ...
        move: function (t) {
          ...
          if (!(0 == n || this.prevPos === this.pos || !this.dragging && Math.abs(n) < this.threshold)) {
            ...
            }), (this.index === r && this.prevIndex !== r || u) && Kt(i[this.index], "itemshown", [this]), l && (this.prevIndex = r, this.index = s, d || Kt(h, "beforeitemhide", [this]), Kt(c, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), h, !d && c), l && (d || Kt(h, "itemhide", [this]), Kt(c, "itemshow", [this]))
          }
        },
        end: function () {
          var t;
        ...
        if (void 0 === e && (e = !1), !this.dragging && this.length) {
          ...
          if (i[e ? "unshift" : "push"](t), !e && 1 < i.length) 2 === i.length && this._transitioner.forward(Math.min(this.duration, 200));
            ...
            var s, a, u = this.getIndex(this.index),
              h = He(this.slides, this.clsActive) && this.slides[u],
              c = this.getIndex(t, this.index),
              l = this.slides[c];
            if (h !== l) {
              if (this.dir = (a = u, "next" !== (s = t) && ("previous" === s || s < a) ? -1 : 1), this.prevIndex = u, this.index = c, h && !Kt(h, "beforeitemhide", [this]) || !Kt(l, "beforeitemshow", [this, h])) return this.index = this.prevIndex, void o();
              var d = this._show(h, l, e).then(function () {
                return h && Kt(h, "itemhidden", [n]), Kt(l, "itemshown", [n]), new ae(function (t) {
                  yn.write(function () {
                    i.shift(), i.length ? n.show(i.shift(), !0) : n._transitioner = null, t()
                  })
                })
              });
              return h && Kt(h, "itemhide", [this]), Kt(l, "itemshow", [this]), d
            }
            o()
          }
        }
      ...
      events: [{
        ...
        handler: function (t, r) {
          var o = this,
            ...
            s = r.alt;
          void 0 === s && (s = "");
          var a, u, n, h = r.poster,
            c = r.attrs;
          void 0 === c && (c = {}), this.setItem(r, "<span uk-spinner></span>"), i && (u = {
            frameborder: "0",
            allow: "autoplay",
            allowfullscreen: "",
    ...
    ao = {
        ...
        props: function (g, m) {
          ...
          return so.reduce(function (t, e) {
            ...
            if (r ? (a = m.style.color, s = s.map(function (t) {
                ...
                return bn(t, u, v.$el)
              }), Re(m, "background-position-" + e[2], ""), i = Re(m, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], n = v.covers ? (h = Math.min.apply(Math, s), c = Math.max.apply(Math, s), l = s.indexOf(h) < s.indexOf(c), d = c - h, s = s.map(function (t) {
                return t - (l ? h : c)
      ...
      update: {
        read: function (t) {
          ...
          }, c = rt.cover(h, u), this.bgProps.forEach(function (t) {
            var e, n = l.props[t],
              i = n.diff,
              r = n.bgPos,
              o = n.steps,
        ...
        Transitioner: function (r, i, o, t) {
          ...
          return {
            ...
            show: function (t, e, n) {
              void 0 === e && (e = 0);
              var i = n ? "linear" : s;
              return t -= Math.round(t * tt(e, -1, 1)), this.translate(e), r && this.updateTranslates(), e = r ? e : tt(e, 0, 1), mo(this.getItemIn(), "itemin", {
                percent: e,
                duration: t,
                timing: i,
                dir: o
            ...
            forward: function (t, e) {
              return void 0 === e && (e = this.percent()), Qe.cancel(a), this.show(t, e, !0)
            },
            translate: function (t) {
              var e = this.getDistance() * o * (lt ? -1 : 1);
              Re(a, "transform", Yr(tt(e - e * t - h, -po(a), an(a).width) * (lt ? -1 : 1), "px")), this.updateTranslates(), r && (t = tt(t, -1, 1), mo(this.getItemIn(), "itemtranslatein", {
                percent: t,
                dir: o
      ...
      computed: {
        ...
        sets: function (t) {
          ...
          return !O(e = e && this.slides.reduce(function (t, e, n) {
            var i, r = an(e).width;
            return a < h + r && (!o.center && n > o.maxIndex && (n = o.maxIndex), b(t, n) || (i = o.slides[n + 1], o.center && i && r < u - an(i).width / 2 ? u -= r : (u = s, t.push(n), a = h + s + (o.center ? r / 2 : 0)))), h += r, t
          }, [])) && e
        },
        transitionOptions: function () {
          return {
  ...
  var ko, $o, Io = G({}, qr, {
    ...
    To = {
      ...
      methods: {
        ...
        start: function (t) {
          var e, n, i;
          this.drag = (e = this.$container, n = this.placeholder, ot(i = be(e, n.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, "$1div$2")), "style", ot(i, "style") + ";margin:0!important"), Re(i, G({
          ...
          }), De(this.drag, this.clsDrag, this.clsCustom), De(this.placeholder, this.clsPlaceholder), De(this.items, this.clsItem), De(document.documentElement, this.clsDragState), Kt(this.$el, "start", [this, this.placeholder]), r = this.pos, o = Date.now(), ko = setInterval(function () {
            var t = r.x,
              a = r.y;
  ...
  var Eo = [],
    ...
    Co = {
      ...
      events: {
        ...
        dragover: function (t) {
          No(t), De(this.$el, this.clsDragover)
        },
