...
$(document).ready(function () {
  ...
  $(function () {
    $(".js-master-readmore").readmore({
      speed: 500,
      lessLink:
        '<div class="js-master-readmore-btn"><a href="#">Свернуть</a></div>',
      moreLink:
        '<div class="js-master-readmore-btn"><a href="#">Читать еще</a></div>',
      collapsedHeight: 60,
    });
  });
  ...
  $(function () {
    $(".js-category-readmore").readmore({
      speed: 500,
      lessLink:
        '<div class="js-category-readmore-btn close"><a href="#">Свернуть</a></div>',
      moreLink:
        '<div class="js-category-readmore-btn"><a href="#">Показать еще</a></div>',
      collapsedHeight: 115,
    });
  });
