...
$(document).ready(function () {
  ...
  $(".js-menu-close").click(function () {
    $(".header__mobile-menu_overlay").removeClass("d-block");
    $(".header__mobile-menu_navigation").removeClass(
      "header__mobile-menu_navigation_active"
    );
  });
  ...
  let childSeatPrice = parseFloat(
    $("[data-child-seat-price]").attr("data-child-seat-price")
  );
  let exstraDriverPrice = parseFloat(
    $("[data-exstra-driver-price]").attr("data-exstra-driver-price")
  );
  ...
  $("[data-child-seat-count]").change(function () {
    ...
    if ($(this).prop("checked") && seatCount == 1) {
      if ($("[data-old-count-seat]").attr("data-old-count-seat") == 2) {
        allPrice =
          parseFloat($("[data-all-price]").attr("data-all-price")) -
          childSeatPrice * 2;
